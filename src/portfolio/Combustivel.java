...
public class Combustivel extends JDialog {
	 ...
	 */
	public Combustivel() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Combustivel.class.getResource("/img/gas.png")));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (txtEtanol.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Informe o Etanol");
					txtEtanol.requestFocus();
				} else {
					if (txtGasolina.getText().equals("")) {
		...
		btnNewButton.setBounds(10, 85, 112, 23);
		...
		btnNewButton_1.setBounds(166, 87, 105, 21);
		getContentPane().add(btnNewButton_1);

		RestrictedTextField validar = new RestrictedTextField(txtGasolina);
		RestrictedTextField validar1 = new RestrictedTextField(txtEtanol);
