...
public class AppServico extends JDialog {
	...
	public AppServico() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (txtCargaHoraria.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Informe a CargaHoraria");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (txtTempoEstimado.getText().equals("")) {
		...
		btnLimpar.setBounds(181, 317, 85, 21);
		getContentPane().add(btnLimpar);
		{
			limpar();
		}

		RestrictedTextField validar = new RestrictedTextField(txtCusto);
		RestrictedTextField validar1 = new RestrictedTextField(txtCargaHoraria);
		RestrictedTextField validar2 = new RestrictedTextField(txtRemuneracao);
		RestrictedTextField validar3 = new RestrictedTextField(txtTempoEstimado);
